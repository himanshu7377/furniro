  ...
  return (
    <div className='relative mx-5 overflow-hidden h-64 md:h-96 lg:h-80 xl:h-96'>
      ...
      <div className='absolute inset-0 flex items-center justify-end px-10'>
        <div className='bg-orange-300 bg-opacity-70 p-1 md:p-4 text-white text-center md:text-left h-48 md:h-60'>
          <p className='text-m md:text-lg lg:text-lg xl:text-m block mb-2 text-black'>
            New Arrival
          </p>
          <div>
